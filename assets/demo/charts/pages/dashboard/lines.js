...
var DashboardLines = (function () {
  ...
  var _AppSalesLinesChart = function (element, height) {
    ...
    if (element) {
      ...
      var tooltip = d3
        ...
        .html(function (d) {
          return (
            ...
            "<li>" +
            '<div class="fs-base my-1"><i class="ph-arrow-circle-left me-2"></i>' +
            d.name +
            " app" +
            "</div>" +
            "</li>" +
      ...
      d3.csv(
        "../../../assets/demo/data/dashboard/app_sales.csv",
        function (error, data) {
          formatted = data;
          redraw();
        }
      ...
      var tooltip = d3
        ...
        .html(function (d) {
          return (
            '<ul class="list-unstyled mb-1">' +
            "<li>" +
            '<div class="fs-base my-1"><i class="ph-check-circle me-2"></i>' +
            formatDate(d.date) +
            "</div>" +
            "</li>" +
            "<li>" +
