...
var D3Streamgraph = (function () {
  ...
  var _streamgraph = function () {
    ...
    if (element) {
      ...
      var colors = d3Container.append("style").attr("type", "text/css").html(`
      ...
      d3.csv(
        "../../../assets/demo/data/dashboard/traffic_sources.csv",
        function (error, data) {
          // Pull out values
          ...
          d3Container.on("mousemove", function (d, i) {
            ...
            tooltip.style(
              "top",
              mousey -
                this.querySelector(".d3-tip").getBoundingClientRect().height /
                  2 -
                2 +
                "px"
            ...
            if (
              ...
              this.getBoundingClientRect().width -
                this.querySelector(".d3-tip").getBoundingClientRect().width -
                margin.right -
                tooltipOffset * 2
            ) {
              tooltip
                .style(
                  "left",
                  mousex -
                    this.querySelector(".d3-tip").getBoundingClientRect()
                      .width -
                    tooltipOffset +
                    "px"
